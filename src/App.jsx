            ...
            <div className={'max-w-[62.5em] w-full border-1 relative h-[37.5em] '}>
                ...
                <div>
                    <div id='desktop' className='w-[34.1875em] absolute left-[13.75em] top-[2.5em] z-10  bo'>
                        <img className='relative z-10 w-max h-auto'
                            src={imac}
                            alt="" />
                        <div className='bg-black absolute z-10 top-[2.125em] left-[1.375em] right-[1.40625em] bottom-[9.3125em] overflow-hidden'>
                            <iframe src={url} className='scale-[.226] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-[2240px] h-[1210px]' title="W3Schools Free Online Web Tutorials" />
                        </div>
                    </div>
                </div>
